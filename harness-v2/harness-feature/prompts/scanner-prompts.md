...
> Scanner 完整 5 阶段 pipeline 规范见 [`../../../harness-common/references/project-scanner.md`](../../../harness-common/references/project-scanner.md)。
> Stage -0.5 检索与注入规范见 [`../../../harness-common/references/knowledge-retrieval.md`](../../../harness-common/references/knowledge-retrieval.md)。
